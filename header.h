...
_inline int hamming_weight (int);										//calculate Hamming weightvoid header();
...
int* get_support (u8 **, int, int*, int*, int);			//for algebraic immunity
MAT* get_matrix (u8 **, int, MAT*, int*, int, int, int);	//for algebraic immunity
